			...
			<div class="col-xl-9 col-lg-12 col-md-9" style="padding-top: 50px;">
				...
				<div class="card o-hidden border-0 shadow-lg my-5" ">
					<div class="card-body p-0">
						...
						<div class="row">
							<div class="col-lg-6 d-none d-lg-block bg-login-image" style="background-image: url('/pdamkaranganyar/assets/img/bg.png')"></div>
							<div class="col-lg-6">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h6 text-gray-900 mb-4"><img src="/pdamkaranganyar/assets/img/logo.png" style="width: 100px; height: 70px;"></h1>
										<h2 class="h3 text-info mb-4"><b>Login</b></h2>
									</div>
									...
									<hr>
									<div class="text-center">
										<a class="small text-info" href="<?= base_url('AuthLogin/register'); ?>" style="font-size:14px;">Daftar Pasang Baru!</a>
									</div>
								</div>
							</div>
						</div>
