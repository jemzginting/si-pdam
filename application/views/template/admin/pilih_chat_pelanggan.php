			...
			$.ajax({
				...
				success: function(data) {
					...
					for (var i = 0; i < data.length; i++) {
						...
						var btn1 = '<a href="http://localhost/pdamkaranganyar/AdminControl/chat_pelanggan?id=' + data[i]["id_user"] + '&name=' + data[i]["name"] + '"   target="_blank" type="button" class="btn btn-xs btn btn-light btn_chat"><i class="far fa-comment"></i>' + data[i]["name"] + '</a>';
