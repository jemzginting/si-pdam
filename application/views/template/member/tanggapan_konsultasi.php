				...
				<table class="table table-bordered" id="tanggapan_konsultasi" width="100%">
					<thead>
						<tr>
							...
							<th width="12%"><center>Nama</center></th>
							<!-- <th width="10%"><center>Alamat</center></th> -->
							<th width="7%"><center>No.Telepon</center></th>
							<th width="10%"><center>Photo KTP</center></th>
							<th width="5%"><center>Tanggal Permohonan</center></th>
							<th width="5%"><center>Jenis Informasi</center></th>
							<th width="18%"><center>Tanggapan Konsultasi</center></th>
	...
	$('#tanggapan_konsultasi').ready(function() {
		...
		function load_data() {
			$.ajax({
				...
				url: '<?php echo site_url('MemberControl/get_tanggapan_konsultasi') ?>',
				dataType: "JSON",
